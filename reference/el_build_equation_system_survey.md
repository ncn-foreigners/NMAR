...
Returns a function that evaluates the stacked EL system for survey
designs using design weights. Unknowns are \\\theta = (\beta, z,
...
reduces to the QLS equations 6-10.
