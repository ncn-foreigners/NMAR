...
TO DO - Describe the package structure, architecture, user interface, shared features like bootstrap and standardization options
...
-   It took me few weeks to understand it, thus I am not able to explain this in 3 minutes 🤫
...
## Empirical Likelihood Estimator: Theoretical Background
TO DO

## Practical Implementation of Empirical Likelihood
TO DO

## Exponential Tilting and Empirical Likelihood in Action
or jsut "NMAR PACKAGE IN ACTION"??
...
TO DO - Large-scale data, further stability improvements, planned extensions, otehr estimators
