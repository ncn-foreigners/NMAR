...
#' Other engines in the package (for example, exponential tilting) may support the
#' delta method. Survey bootstrap uses replicate-weight designs via \pkg{svrep}
#' and \pkg{survey}, as implemented in \code{bootstrap_variance.survey.design}.
#'
#' @references
