...
cat('Est Y mean (NMAR):    ', sprintf('%.4f', res$y_hat), 
    '  3σ interval: (', sprintf('%.4f', res$y_hat - 3*res$se), 
    ', ', sprintf('%.4f', res$y_hat + 3*res$se), 'σ=',sprintf('%.4f',res$se),')\n')
