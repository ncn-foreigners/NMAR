...
if (requireNamespace("survey", quietly = TRUE)) {
  ...
  engine <- el_engine(auxiliary_means = c(ell = pop_mean_ell), variance_method = "none", standardize = TRUE)
...
- Probit stability: the response-model score uses $\mu.\eta(\eta)/\mathrm{linkinv}(\eta)$ with clipping; for probit this behaves like $\phi/\Phi$ when probabilities are bounded away from 0 and 1.
