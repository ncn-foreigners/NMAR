...
- **trim_cap** (default: Inf)
  - Caps EL weights and redistributes mass. Trimming is applied only after solving the EL system to the
    ...
    untrimmed masses. The reported $\hat Y$ and returned weights are computed from the trimmed masses, so trimming changes the point estimate. Prefer `variance_method = "bootstrap"` when trimming is finite.
