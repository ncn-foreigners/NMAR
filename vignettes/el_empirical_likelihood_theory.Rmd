...
package. When `variance_method = "delta"` is requested, `el_engine()` coerces it
to `"none"` (with a warning) and variance is skipped (`se = NA_real_` with an
explanatory message). We recommend `variance_method = "bootstrap"` for standard
errors in both IID and survey settings.
