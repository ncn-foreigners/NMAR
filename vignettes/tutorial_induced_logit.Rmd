...
This vignette demonstrates the induced logistic regression
estimator for Not Missing at Random outcomes implemented in the `NMAR`
package.
...
The induced-logit engine uses the two RHS blocks:
