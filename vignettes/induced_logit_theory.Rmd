...
This vignette documents the induced logistic regression estimator implemented
in the `NMAR` package. It has two goals:
...
Induced-logit engine fits a linear-in-parameters regression for $\mu(x;\xi)$
built from a standard model matrix. Concretely:
...
- Explicit GLM convergence checks and NA-coefficient checks.
